...
# AMD MI300X version of the run script for Qwen3-8B SFT agent training
# This script launches the training in tmux with proper AMD GPU settings

set -e

SESSION_NAME="slime_qwen3_sft_amd_run"
WINDOW_1="slime"
WINDOW_2="buffer"
...
tmux send-keys -t ${SESSION_NAME}:${WINDOW_1} "bash ./scripts/agent-kbench-qwen3-8B-sft-amd.sh |& tee /workspace/slime/logs/slime_qwen3_sft_amd_train.log" C-m
...
tmux send-keys -t ${SESSION_NAME}:${WINDOW_2} "python buffer.py |& tee /workspace/slime/logs/buffer_qwen3_sft_amd.log" C-m

# Window 3: Evaluation server (using separate GPUs)
...
tmux send-keys -t ${SESSION_NAME}:${WINDOW_3} "python scripts/eval_server_subprocess.py |& tee /workspace/slime/logs/eval_server_qwen3_sft_amd.log" C-m

# Create logs directory if it doesn't exist
mkdir -p /workspace/slime/logs

echo "============================================"
echo "AMD MI300X Training Session Started"
echo "============================================"
echo ""
...
echo "  3. $WINDOW_3 - Evaluation server (GPUs 6-7)"
echo ""
echo "Logs:"
echo "  Training: /workspace/slime/logs/slime_qwen3_sft_amd_train.log"
echo "  Buffer:   /workspace/slime/logs/buffer_qwen3_sft_amd.log"
echo "  Eval:     /workspace/slime/logs/eval_server_qwen3_sft_amd.log"
echo ""
