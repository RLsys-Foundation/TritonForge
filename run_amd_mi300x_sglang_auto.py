...
Auto mode - runs single sample evaluation without user input
"""
...
def main():
    """Main function."""
    print("KernelBench AMD MI300X + SGLang Evaluation (Auto Mode)")
    print("=" * 60)
    ...
    # Automatically run single sample evaluation
    print("\nAutomatically running single sample evaluation...")
