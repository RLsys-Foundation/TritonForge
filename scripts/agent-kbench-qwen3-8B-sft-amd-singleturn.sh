...
# SINGLE-TURN version with reduced batch sizes for debugging
...
ROLLOUT_ARGS=(
   ...
   # CHANGED: Use single-turn task type
   --rm-type kernelbench
   ...
   --balance-data
   # REMOVED: Multi-turn specific parameters
   # --max-turns 3
   # --gamma 0.4
)
...
PERF_ARGS=(
   ...
   # Dynamic batching with reduced limits for debugging
